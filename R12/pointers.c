...
void exercise4()
{
    ...
    // Add code to print out the sixth character using %c and array access
    printf("string0, char6: %c\n", string0[5]);
    printf("string1, char6: %c\n", string1[5]);
    printf("string2, char6: %c\n", string2[5]);
}
...
void exercise5()
{
    ...
    printf("Address of intArray[2] = %p\n", &intArray[2]);
    printf("Pointer to intArray = %p\n", &intArray);
    printf("Pointer to intFloat = %p\n", &intFloat);
    printf("Pointer to intChar = %p\n", &intChar);
